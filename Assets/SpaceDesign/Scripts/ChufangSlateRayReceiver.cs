...
{
    public class ChufangSlateRayReceiver : RayPointerHandler
    {
        private ChufangSlateController slateController;

        void Start()
        {
            if (gameObject.GetComponent<ChufangSlateController>() != null)
                slateController = gameObject.GetComponent<ChufangSlateController>();
        }
